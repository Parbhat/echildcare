# Django settings for echildcare project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a echildcare directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'echildcare')
...
SECRET_KEY = '(3zjlh38bk345mmvzfs))08n30gx@hy7oz0x8omw(k%7xo^b#9'
...
ROOT_URLCONF = 'echildcare.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'echildcare.wsgi.application'
...
RAPIDSMS_HANDLERS = (
    ...
    "register.handlers.language.LanguageHandler",
    "register.handlers.name.NameHandler",
    "register.handlers.gender.GenderHandler",
    "register.handlers.email.EmailHandler",
    "register.handlers.pincode.PincodeHandler",
    "register.handlers.register.RegisterHandler",
)

DEFAULT_RESPONSE = "Sorry, echildcare could not \
